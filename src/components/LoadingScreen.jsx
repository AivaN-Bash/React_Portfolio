...
const S = {
  ...
  ring1:   { position:"absolute", width:340, height:340, borderRadius:"50%",
             border:"1px solid rgba(0,200,255,0.15)",
             animation:"spin 8s linear infinite", borderTopColor:"#00c8ff",
             borderRightColor:"rgba(0,200,255,0.05)" },
  ring2:   { position:"absolute", width:250, height:250, borderRadius:"50%",
             border:"1px solid rgba(232,0,60,0.1)",
             animation:"spinR 10s linear infinite", borderBottomColor:"#e8003c",
             borderRightColor:"rgba(232,0,60,0.05)" },
  ...
  barFill: { height:"100%",
             background:"linear-gradient(90deg,#00c8ff,#0050a0)",
